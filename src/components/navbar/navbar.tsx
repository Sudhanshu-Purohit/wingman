...
const Navbar = () => {
    ...
    const Logo = () => (
        <div className="w-[33.2px] h-[33.2px] sm:hidden bg-gradient-to-br from-white/80 to-[#09544D] rounded-[5.2px] flex items-center justify-center relative">
        ...
        <div className={cn(
            ...
            {navigation.map((item) => (
                <Link
                    ...
                    href={item.href}
                    className={cn(
                        "flex items-center space-x-2 text-sm font-medium p-2 rounded-full transition-colors",
                        pathname === item.href
    ...
    return (
        <nav className="border-b w-full fixed top-0 z-10 bg-[#115E56] sm:bg-white">
            <div className="flex items-center justify-between sm:justify-start px-4 py-4 md:px-6 md:py-5">
                <Logo />
